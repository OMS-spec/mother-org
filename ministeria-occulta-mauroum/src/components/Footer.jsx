    ...
    <footer style={{ position: 'relative', marginTop: '10vh' }}>
      ...
      <div style={{ position: 'relative', background: '#0b0b0b', color: '#f5f5f5', padding: '10vh 6vw', overflow: 'hidden' }}>
        <img
          ...
          alt=""
          style={{ position: 'absolute', left: 0, bottom: -10, width: 260, opacity: 0.9, filter: 'grayscale(1) contrast(1.1)' }}
        />
        <img
          src="/assets/footer-right.jpg"
          alt=""
          style={{ position: 'absolute', right: 0, bottom: -10, width: 260, opacity: 0.9, filter: 'grayscale(1) contrast(1.1)' }}
        />
...
<p className="body-copy" style={{ textAlign: 'center', color: '#777', marginTop: '8px', maxWidth: 'none' }}>
